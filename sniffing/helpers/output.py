...
COLUMNS = [
    ...
    'type', 'result',
    # Counts
    'pre_odor_sniffs', 'post_odor_sniffs'
    # Latencies
    'sniff_1_latency', 'sniff_2_latency', 'sniff_3_latency',
    # Durations
    'pre_sniff_dur_3', 'pre_sniff_dur_2', 'pre_sniff_dur_1', 'post_sniff_dur_1', 'post_sniff_dur_2', 'post_sniff_dur_3',
]
...
def repack_data(h5_file: DewanH5, inhale_counts, inhale_latencies, inhale_durations, output_dir):
    ...
    combined_df.loc[:, ['sniff_1_latency', 'sniff_2_latency', 'sniff_3_latency']] = inhale_latencies.T
    ...
    post_fv_inhale_durations = inhale_durations.loc[inhale_durations.index >=0].iloc[:3]

    unpack_inhale_durations(inhale_durations, trials)

    _pre_fv_inhale_durations.iloc[:pre_fv_inhale_durations.shape[0]] = pre_fv_inhale_durations
    _post_fv_inhale_durations.iloc[:post_fv_inhale_durations.shape[0]] = post_fv_inhale_durations
    combined_df.loc[:, ['pre_sniff_dur_3', 'pre_sniff_dur_2', 'pre_sniff_dur_1']] = _pre_fv_inhale_durations
    combined_df.loc[:, ['post_sniff_dur_1', 'post_sniff_dur_2', 'post_sniff_dur_3']] = _post_fv_inhale_durations
